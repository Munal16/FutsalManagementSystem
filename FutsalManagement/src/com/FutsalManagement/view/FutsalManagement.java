...
public class FutsalManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblbooking.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Booking Date", "Booking Id", "Location", "Full Name", "Contact", "Total Cost"
            }
        ));
    ...
    private void btnHomeToBookingActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void initializeData() {
        ...
        registerBooking(new BookingModel("2024-05-11", "758374","Yalla", "Bimarshaa", "9860898172","2000"));
        registerBooking(new BookingModel("2024-02-12", "239846","Imadol", "RonikRaut", "9818928272","1500"));
            registerBooking(new BookingModel("2025-01-01", "837583","Bandit Court", "Snail Chitrakar", "9818928272","2500"));
}
    ...
    private void registerBooking(BookingModel booking) {
        ...
        model.addRow(new Object[]{
            booking.getBookingDate(), booking.getBookingId(),booking.getLocation(), booking.getFullName(),
            booking.getcontact(), booking.getTotalCost()
        });
    }
    /**
  ...
  private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
    ...
    private void loadListToTable(List<BookingModel> BookingList) {
        ...
        BookingList.forEach(Booking -> model.addRow(new Object[]{
